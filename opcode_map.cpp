...
std::unordered_map<uint32_t, InstructionDetails> opcodeMap = {
    ...
    {0xB4, {2, 1, 1, 1, 1, false, false, true, "MOV SPL, imm8"}},
    {0xB5, {2, 1, 1, 1, 1, false, false, true, "MOV BPL, imm8"}},
    {0xB6, {2, 1, 1, 1, 1, false, false, true, "MOV SIL, imm8"}},
    {0xB7, {2, 1, 1, 1, 1, false, false, true, "MOV DIL, imm8"}},
